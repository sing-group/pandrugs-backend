    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(
                new Object[][] {
                         ...
                         */
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.MUTATED.toString(), "AMP", ""),
                                "GenA (oncogene) is mutated and it is amplified"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.MUTATED.toString(), "DEL", ""),
                                "GenA (oncogene) is mutated and it is deleted"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.MUTATED.toString(), "DIPLOID",
                                        ""),
                                "GenA (oncogene) is mutated and it is diploid"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.NOT_MUTATED.toString(), "AMP",
                                        ""),
                                "GenA (oncogene) is not mutated and it is amplified"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.NOT_MUTATED.toString(), "DEL",
                                        ""),
                                "GenA (oncogene) is not mutated and it is deleted"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.MUTATED.toString(), "AMP", ""),
                                "GenA (tumor suppressor gene) is mutated and it is amplified"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.MUTATED.toString(), "DEL", ""),
                                "GenA (tumor suppressor gene) is mutated and it is deleted"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.MUTATED.toString(), "DIPLOID",
                                        ""),
                                "GenA (tumor suppressor gene) is mutated and it is diploid"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.NOT_MUTATED.toString(), "AMP",
                                        ""),
                                "GenA (tumor suppressor gene) is not mutated and it is amplified"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.NOT_MUTATED.toString(), "DEL",
                                        ""),
                                "GenA (tumor suppressor gene) is not mutated and it is deleted"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, SnvAnnotation.MUTATED.toString(),
                                        "AMP", ""),
                        ...
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED,
                         ...
                         */
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.MUTATED.toString(), "",
                        ...
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, SnvAnnotation.NOT_MUTATED.toString(), "",
                                        "HIGHLY_OVEREXPRESSED"),
                                "GenA (oncogene) is not mutated and it is highly overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, SnvAnnotation.MUTATED.toString(), "",
                                        "OVEREXPRESSED"),
                         ...
                         */
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "AMP", "HIGHLY_OVEREXPRESSED"),
                                "GenA (oncogene) is amplified and it is highly overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "AMP", "OVEREXPRESSED"),
                                "GenA (oncogene) is amplified and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "AMP", "UNDEREXPRESSED"),
                                "GenA (oncogene) is amplified and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "AMP", "NOT_EXPRESSED"),
                                "GenA (oncogene) is amplified and it is not expressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "DEL", "HIGHLY_OVEREXPRESSED"),
                                "GenA (oncogene) is deleted and it is highly overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "DEL", "OVEREXPRESSED"),
                                "GenA (oncogene) is deleted and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "DEL", "UNDEREXPRESSED"),
                                "GenA (oncogene) is deleted and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "DEL", "NOT_EXPRESSED"),
                                "GenA (oncogene) is deleted and it is not expressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.ONC, "", "DIPLOID", "HIGHLY_OVEREXPRESSED"),
                                "GenA (oncogene) is diploid and it is highly overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "AMP", "OVEREXPRESSED"),
                                "GenA (tumor suppressor gene) is amplified and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "AMP", "UNDEREXPRESSED"),
                                "GenA (tumor suppressor gene) is amplified and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "AMP", "NOT_EXPRESSED"),
                                "GenA (tumor suppressor gene) is amplified and it is not expressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "DEL", "OVEREXPRESSED"),
                                "GenA (tumor suppressor gene) is deleted and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "DEL", "UNDEREXPRESSED"),
                                "GenA (tumor suppressor gene) is deleted and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.TSG, "", "DEL", "NOT_EXPRESSED"),
                                "GenA (tumor suppressor gene) is deleted and it is not expressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "AMP", "OVEREXPRESSED"),
                                "GenA is amplified and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "AMP", "UNDEREXPRESSED"),
                                "GenA is amplified and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "AMP", "NOT_EXPRESSED"),
                                "GenA is amplified and it is not expressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "DEL", "OVEREXPRESSED"),
                                "GenA is deleted and it is overexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "DEL", "UNDEREXPRESSED"),
                                "GenA is deleted and it is underexpressed"
                        },
                        {
                                new GeneExpressionCoherence("GenA", DriverGene.UNCLASSIFIED, "", "DEL", "NOT_EXPRESSED"),
