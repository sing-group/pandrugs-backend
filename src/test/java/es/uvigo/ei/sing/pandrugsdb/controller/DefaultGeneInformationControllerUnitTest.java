...
import static es.uvigo.ei.sing.pandrugsdb.persistence.entity.GeneInformationDataset.geneInformation;
...
public class DefaultGeneInformationControllerUnitTest {
	@TestSubject
	private DefaultGeneInformationController controller =
		new DefaultGeneInformationController();
	...
	private void prepareDaoGet(String ... geneSymbols) {
		...
		for (String geneSymbol : geneSymbols) {
			expect(dao.get(geneSymbol)).andReturn(geneInformation(geneSymbol));
		}
