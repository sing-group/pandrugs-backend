...
public class GeneDrugGroupInfos {
	...
	public GeneDrugGroupInfos(List<GeneDrugGroup> geneDrugs) {
		this.geneDrugs = geneDrugs.stream()
			.sorted((g1, g2) -> Compare.objects(g1, g2)
				.byDouble(GeneDrugGroup::getDScore)
					.thenByInt(GeneDrugGroup::countTargetGenes)
					.thenByInt(GeneDrugGroup::countDirectGenes)
					.thenByInt(GeneDrugGroup::countIndirectGenes)
					.thenBy(GeneDrugGroup::getDrug)
					.thenByArray(GeneDrugGroup::getFamilies)
					.thenBy(GeneDrugGroup::getStatus)
					.thenBy(GeneDrugGroup::getCancer)
					.thenBy(GeneDrugGroup::getExtra)
					.thenBy(GeneDrugGroup::isTarget)
				.andGetInReverseOrder())
	...
	public boolean equals(Object obj) {
		...
		} else if (!geneDrugs.equals(other.geneDrugs)) {
			return false;
		}
		return true;
	}
